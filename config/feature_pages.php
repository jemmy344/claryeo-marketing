...
return [
    ...
    'ai-assistant' => [
        ...
        'faqs' => [
            ...
            ['question' => 'Is my financial data safe when I use the AI?', 'answer' => 'Your data stays within your private Claryeo account and is only used to answer your own questions. Bank connections use secure Open Banking, which is read-only, so the assistant can see your transactions but can never move your money.'],
