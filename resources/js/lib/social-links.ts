/**
 * Canonical social links and SVG icon paths for Claryeo.
 * Use this module anywhere we display X, LinkedIn, or Instagram (footer, contact, etc.).
 */

export const socialLinks = [
    {
        href: 'https://x.com/claryeoofficial',
        label: 'X/Twitter',
    ...
    {
        href: 'https://www.linkedin.com/company/claryeo/',
        label: 'LinkedIn',
    ...
    {
        href: 'https://instagram.com/claryeoofficial',
        label: 'Instagram',
