    ...
    const trigger = (key: MenuKey, label: string) => (
        ...
        >
            <button
                ...
                className={cn(
                    'flex items-center gap-1 text-sm transition-colors rounded-sm outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
                    isDark
                        ? openMenu === key
                            ? 'text-paper'
            ...
            <nav className="mx-auto flex h-14 w-full max-w-[1180px] items-center justify-between px-4 md:px-0">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className={cn(
                            'inline-flex items-center justify-center rounded-full border p-2.5 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:hidden',
                            isDark
