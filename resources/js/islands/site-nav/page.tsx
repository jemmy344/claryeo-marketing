    ...
    const trigger = (key: MenuKey, label: string) => (
        ...
        >
            <button
                ...
                className={cn(
                    'flex items-center gap-1 text-sm transition-colors rounded-md px-1 py-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
                    isDark
                        ? openMenu === key
                            ? 'text-paper'
