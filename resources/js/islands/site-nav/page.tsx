    ...
    const trigger = (key: MenuKey, label: string) => (
        ...
        >
            <button
                ...
                className={cn(
                    'flex items-center gap-1 rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary',
                    isDark
                        ? openMenu === key
                            ? 'text-paper'
            ...
            <nav className="mx-auto flex h-14 w-full max-w-[1180px] items-center justify-between px-4 md:px-0">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className={cn(
                            'inline-flex items-center justify-center rounded-full border p-2.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary md:hidden',
                            isDark
