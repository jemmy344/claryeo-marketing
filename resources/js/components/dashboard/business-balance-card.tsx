...
function EyeToggle({
    ...
    return (
        <button
            type="button"
            onClick={onToggle}
            className="group relative shrink-0 rounded-md p-1.5 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
